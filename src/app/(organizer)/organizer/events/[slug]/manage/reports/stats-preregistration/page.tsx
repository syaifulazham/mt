...
export const metadata: Metadata = { title: "Laporan Statistik Penyertaan" };

export default async function StatsPreregistrationPage({ params }: { params: Promise<{ slug: string }> }) {
