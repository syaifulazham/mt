...
export default async function FinalProgramReportPage({
  ...
  const grandTotal =
    d.regSummary.schoolParticipants +
    d.regSummary.beliaParticipants +
    d.walkInSummary.total;

  return (
    <OrganizerShell userName={session.name} role={session.role}>
      {/* ── toolbar ─────────────────────────────────────────────────────────── */}
      <div className="flex items-center gap-3 px-6 py-4 border-b bg-white print:hidden flex-wrap">
        <Link
      ...
      <div className="px-6 py-6 space-y-6 print:px-0 print:py-0 bg-slate-100 min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 print:grid-cols-2">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="bg-indigo-50">
                      ...
                      <td className="px-3 py-2 text-center font-mono font-bold text-indigo-900 text-sm tabular-nums">
                        {n(d.schoolMale)}
                      </td>
                      <td className="px-3 py-2 text-center text-xs text-indigo-700 tabular-nums">
                        {pct(d.schoolMale, d.schoolMale + d.schoolFemale)}%
                      </td>
                    </tr>
                    <tr className="bg-rose-50">
                      ...
                      <td className="px-3 py-2 text-center font-mono font-bold text-rose-900 text-sm tabular-nums">
                        {n(d.schoolFemale)}
                      </td>
                      <td className="px-3 py-2 text-center text-xs text-rose-700 tabular-nums">
                        {pct(d.schoolFemale, d.schoolMale + d.schoolFemale)}%
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="bg-indigo-50">
                      ...
                      <td className="px-3 py-2 text-center text-xs text-indigo-700 tabular-nums">
                        {pct(d.beliaMale, d.beliaMale + d.beliaFemale)}%
                      </td>
                    </tr>
                    <tr className="bg-rose-50">
                      <td className="px-3 py-2 text-xs font-semibold text-rose-900"><span className="flex items-center gap-1"><Venus className="w-3.5 h-3.5" /> Perempuan</span></td>
                      ...
                      <td className="px-3 py-2 text-center text-xs text-rose-700 tabular-nums">
                        {pct(d.beliaFemale, d.beliaMale + d.beliaFemale)}%
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          {/* Right: Ethnicity (Rakan Muda) — tabloid styled */}
