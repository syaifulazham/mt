...
export const metadata: Metadata = { title: "Daftar Akaun — Malaysia Techlympics 2026" };
  ...
  return (
    <>
      <style>{`
        ...
        .signup-hero-content { animation: fadein 0.8s ease both; }
      `}</style>
      ...
      <div style={{ fontFamily: "'Rajdhani', sans-serif", minHeight: "100vh", display: "flex" }}>
        ...
        >
          ...
          <div className="signup-hero-content" style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: 340 }}>
