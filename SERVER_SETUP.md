...
| `WALKIN_VIBEBLOCKS_URL` | VibeBlocks base URL |
| `WALKIN_VIBEBLOCKS_API_KEY` | VibeBlocks API key |
| `WALKIN_EPTIM_DRONE_URL` | Eptim Drone API base URL |
| `WALKIN_EPTIM_DRONE_API_KEY` | Eptim Drone API key (event-scoped) |
